...
export default function DashboardTool(props) {
    const { uploaded, preview, activeProject, user, setError, addBgTask, updateCreditsFromResponse, creditPricing, currentToken, tool, rightPanelEl, handleUpload, handlePreUpload, setTool } = props;
    ...
    const STEP_TYPES_MAP = {
        ...
        extract: { label: 'Pattern Extract', cost: 50 },
        seamless: { label: 'Make Seamless', cost: 80 },
        repeat: { label: 'Repeat Set', cost: 50 },
        vectorize: { label: 'Vectorize SVG', cost: 100 },
        upscale: { label: 'Super Resolution', cost: 60 },
